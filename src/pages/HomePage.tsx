...
const HomePage: React.FC = () => {
    return (
        <div className="mt-5 w-100 h-100 d-flex flex-wrap justify-content-center align-self-center gap-4">
            ...
            <GlassElement
                className="p-2 h-75 w-25 d-flex flex-column justify-content-around fs-5 gap-2 rounded"
            ...
            <GlassElement className="w-50 h-75 d-flex flex-column rounded">
                <div className='wrapperOfLink border-bottom flex-grow-1 rounded-top'>
                    <div className='link front-face-link'>
                    ...
                    <div className="link back-face-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-arrow-up-right" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M14 2.5a.5.5 0 0 0-.5-.5h-6a.5.5 0 0 0 0 1h4.793L2.146 13.146a.5.5 0 0 0 .708.708L13 3.707V8.5a.5.5 0 0 0 1 0v-6z" />
                        </svg>
                    </div>
                </div>
                <div className='wrapperOfLink border-bottom flex-grow-1 '>
                    <div className="link front-face-link">
                ...
                <div className="wrapperOfLink border-bottom flex-grow-1 rounded-bottom">
                    <div className="link front-face-link">
