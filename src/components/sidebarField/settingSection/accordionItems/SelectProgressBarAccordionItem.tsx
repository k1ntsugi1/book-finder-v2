    ...
    return (
        ...
        >
            ...
            <Accordion.Body className="d-flex flex-column">
                ...
                <Button variant="" className="wrapperOfRunnerBorderBottom" onClick={() => appDispatch(actionsUiProgressBar.updateTypeOfProgressBar({typeOfProgressBar: 'straight'}))}>
                    <div className='d-flex justify-content-between'>
                        <span className='me-3'>Straight</span>
                        {
                ...
                <Button variant="" className="wrapperOfRunnerBorderBottom" onClick={() => appDispatch(actionsUiProgressBar.updateTypeOfProgressBar({typeOfProgressBar: 'circle'}))}>
                    <div className='d-flex justify-content-between'>
                        <span className='me-3'>Circle</span>
                        {
