...
const ProviderOfSearchOptions: React.FC<{ children: React.ReactNode }> = (props) => {
  ...
  const searchOptions = {
    typesOfFilter: ['all', 'partial', 'full', 'free-ebooks', 'paid-ebooks', 'ebooks'],
    typesOfOrder: ['all', 'newest', 'relevance'],
    typesOfCategory: ['all', 'art', 'biography', 'computers', 'history', 'medical', 'poetry'],
    typesOfItem: ['all', 'books', 'magazines']
  };
  return (
