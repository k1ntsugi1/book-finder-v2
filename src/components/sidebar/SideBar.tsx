...
const Sidebar: React.FC<Props> = (props) => {
    const [activeItem, setNewActiveItem] = useState<string>('home');
    ...
    const classnamesOfSidebarElement = cn('mx-auto', 'cursor-pointer');
    ...
    return (
        <GlassElement
            ...
            classesOfFrontFace="pt-5 d-flex flex-column justify-content-start gap-5"
        ...
        >
            ...
            <div
                ...
                style={{ 'color': 'var(--color-text)' }}
                onClick={() => {
                    setNewActiveItem('star');
                    handlerOfShowStateOfForm('unvisible')
                    handlerOfShowStateOfBrush('unvisible')
                    setNewTypeOfItems('stared')
                    navigate("/stared");
                    dispatch(fetchDataOfStaredItems());
                }}
            >
                {activeItem === 'star'
                    ?
