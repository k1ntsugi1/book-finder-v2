  ...
  return (
    <div className="d-flex flex-column gap-3">
      <p className="mx-auto fw-bold h5 border-bottom">
        {t('mainField.transcriptionCard.configuration')}
      </p>
      ...
      >
        ...
        <span onClick={activeItemOfOptionHandler('search')}>
          {t('mainField.transcriptionCard.searchOption')}
        </span>
      </RunnerBorderBottom>
      ...
      >
        ...
        <span onClick={activeItemOfOptionHandler('setting')}>
          {t('mainField.transcriptionCard.settingOption')}
        </span>
      </RunnerBorderBottom>
    </div>
  );
