...
import createURLBySearchingOptions from "../../helpersFunc/createURLBySearchingOptions";
...
const fetchGetDataBySearchingOptions = createAsyncThunk<IResultOfSearching, IDataOfSearchingParams, IThunkAPI>(
    'fetchData',
